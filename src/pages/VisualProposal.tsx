        ...
        <div className="min-h-screen bg-[#050505] text-white font-sans overflow-x-hidden">
            ...
            <section className="h-screen flex flex-col items-center justify-center relative px-4 text-center">
                ...
                >
                    ...
                    <h1 className="text-6xl md:text-8xl font-display font-extrabold tracking-tighter mb-8 leading-none italic">
                        BIZZ AUTO <br />
                    ...
                    <p className="text-xl md:text-2xl text-white/60 max-w-3xl mx-auto font-light leading-relaxed">
                        The 24/7 Digital Employee for Next-Gen Auto Sales. <br />
            ...
            <section className="min-h-screen flex flex-col items-center justify-center py-20 px-4 text-center bg-primary">
                ...
                >
                    ...
                    <p className="text-2xl text-white/90 font-medium mb-16 leading-relaxed">
                        Bizz Auto CRM doesn't just save time—it creates a competitive moat for your business.
                    </p>
            ...
            <section className="py-32 px-4 text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                    <Button
                        ...
                        onClick={() => window.open('https://wa.me/94703375336?text=I%27m%20interested%20in%20the%20Bizz%20Auto%20CRM', '_blank')}
                    >
                    ...
                    <Button
                        ...
                        onClick={() => window.location.href = 'mailto:tkavishka101@gmail.com?subject=BizzAuto%20CRM%20Inquiry'}
                    >
